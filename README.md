...
git clone https://github.com/lpb21/btgPactualFront
cd btgPactualFront
```
...
Crea un archivo .env en la raíz del proyecto y añade las siguientes variables, aunque el .env lo subi para fines del ejercicio:
